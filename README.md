...
public delegate void Getpoint();  public event Getpoint Point;  public delegate void GameOver(); public event GameOver onGameOver;  public delegate void Jumps();  public event Jumps jumping;
...
play.onGameOver += GameOverHandle; play.Point += AddPoint; play.jumping += JumpHandle;
